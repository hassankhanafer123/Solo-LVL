...
values
  (:user_id, 'Study', 'timer', 90, 'INT', 75, 1),
  (:user_id, 'Read', 'timer', 30, 'INT', 25, 2),
  (:user_id, 'Push-ups', 'count', 100, 'STR', 50, 3),
  (:user_id, 'Sit-ups', 'count', 100, 'STR', 50, 4),
  (:user_id, 'Squats', 'count', 100, 'STR', 50, 5),
  (:user_id, 'Run (km)', 'count', 5, 'STR', 75, 6),
  (:user_id, 'Meditate', 'timer', 10, 'DIS', 50, 7),
  (:user_id, 'No phone after 11pm', 'checkbox', null, 'DIS', 30, 8);
